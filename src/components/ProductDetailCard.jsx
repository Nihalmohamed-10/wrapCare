    ...
    <div className="w-full lg:w-1/2 bg-[#FDE6F6] h-auto pl-[96px] pr-[96px] flex justify-center p-8 sm:py-20 lg:pl-[25px] lg:pr-[25px] xl:pl-[80px] group hover:bg-[#FDE6F6] transition-colors duration-[4000ms] ease-in-out lg:bg-[#F4F4F5]">
      <div className="mt-[10px] w-[563px] lg:w-full lg:pl-[20px] lg:pr-[20px]">
        ...
        <p className="mt-[30px] font-mona sm:mx-auto text-center text-[20px] w-[320px] sm:w-[430px] md:text-[18px] lg:text-start lg:w-[400px] xl:w-[450px] text-black xl:mx-0 xl:text-[20px] 2xl:w-[500px]">
          ...
          prepared. Don’t let unexpected moments hold you back—choose the
          trusted, hygienic, and convenient solution made for modern women. Buy
          now and experience worry-free freedom wherever life takes you.
        </p>

        <div className="font-mona sm:w-[400px] sm:mx-auto lg:w-[400px] lg:mx-0">
          {/* 🌟 Animated Price Section */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, ease: "easeOut" }}
            className="mt-[20px] mb-4 flex justify-between gap-14 items-center lg:mt-[20px] lg:pl-[20px] lg:justify-start lg:w-[90%]"
          >
            ...
            <div className="flex flex-col">
              <motion.span
                ...
                className="text-[18px] sm:text-[20px] font-bold text-[#e0268e]"
              >
                {price} + Free Shipping
              </motion.span>
          ...
          <div className="lg:pl-[30px] flex justify-center sm:justify-end lg:justify-start">
            <button
              ...
              className="w-full cursor-pointer bg-[#FDE6F6] hover:bg-pink-600 border border-[#E0268E] mt-[10px] pt-[17px] pb-[17px] px-[42px] text-[#c1005e] font-semibold rounded-full sm:w-[200px] lg:mt-[20px] sm:bg-[#E0268E] sm:text-[#FFFFFF] "
            >
              ADD TO CART
            </button>
          </div>
...
//     <div className="w-full lg:w-1/2 bg-[#FDE6F6] h-auto pl-[96px] pr-[96px] flex justify-center p-8 sm:py-20 lg:pl-[25px] lg:pr-[25px] xl:pl-[80px] group hover:bg-[#FDE6F6] transition-colors duration-[4000ms] ease-in-out lg:bg-[#F4F4F5]">
//       <div className="mt-[10px] w-[563px] lg:w-full lg:pl-[20px] lg:pr-[20px]">
//         <p className="font-dm-serif sm:mx-auto text-center text-[20px] w-[320px] sm:w-[430px] md:w-[430px] lg:w-[378px] lg:text-start lg:text-[22px] font-extrabold text-[#E0268E] xl:mx-0 xl:text-[26px] 2xl:w-[500px]">
//           Stay ready anywhere—
//         </p>
...
//         <p className="mt-[30px] font-mona sm:mx-auto text-center text-[20px] w-[320px] sm:w-[430px] lg:text-start lg:w-[500px] text-black xl:mx-0 xl:text-[24px]">
//           All-in-one pack—your essential partner for comfort, confidence, and
//           complete peace of mind on the go. Whether you’re traveling, working
//           long hours, or heading to class, WrapCare ensures you’re always
//           prepared. Don’t let unexpected moments hold you back—choose the
