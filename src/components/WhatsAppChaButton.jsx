...
const WhatsAppChatButton = () => {
  return (
    <a
      href="https://wa.me/917025966234?text=Hi%2C%20I%20need%20support"
      target="_blank"
...
// const WhatsAppChatButton = () => {
//   return (
//     <a href="#" target="_blank" rel="noreferrer noopener" class="fixed bottom-10 right-10 z-50 inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#25d366]">
